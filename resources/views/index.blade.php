                        ...
                        <div class="container-fluid slider_banner p-0 m-0">
                            <div class="row align-items-center slider-animated-1">
                                <div class="col-lg-12 slider_pro">
                                    ...
                                    @else
                                        <img src="{{ asset('storage/' . $_slider->slider_image) }}" class="h-100"
                                            alt="{{ $_slider->alt_tag }}">
                                    @endif
                    ...
                    <div class="col-lg-12 m-0 p-0">
                        ...
                        <div class="row m-0">
                            <div class="col-lg-6 p-0">
                                <video src="assets/video/11.mp4" loop muted autoplay width="100%" height="100%"></video>
                            </div>
                            <div class="col-lg-6 col-md-6 col-12 py-3 ph-md-0 d-flex align-items-start flex-column justify-content-center "
                                style="background:url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTRE2h8-AjCDRTpTM3O6E1rmfBv6iS3R0GaHq2yC0RN_QXomTvh) no-repeat;background-size: cover;">
                                ...
                                <div
                                    class="py-3 d-flex justify-content-end align-items-center view_detail hover-up mx-auto">
                                    <a href="{{ url('customized-jewelry') }}"
                                        class="fs-6">{{ $homeSection->mto_section_btn_title }}<i
                                            class="fa-solid fa-angle-right ps-2"></i></a>
                                </div>
                            </div>
                        </div>
        ...
        <section class="popular-categories section-padding py-80">
            <div class="mx-3 wow fadeIn animated">
                ...
                <div class="carausel-4-columns-cover arrow-center position-relative">
                    ...
                    <div class="carausel-4-columns carausel-arrow-center mb-3   " id="carausel-6-columns">
                        @if ($mostLiked)
                            @foreach ($mostLiked as $_productDetails)
                                <div class="product-cart-wrap my-3 hover-up">
                                        ...
                                        <div class="product-img product-img-zoom">
                                            <a href="{{ route('singleproduct', ['url' => $_productDetails->url_key]) }}">
                                                ...
                                                <img class="default-img"
                                                    src="{{ asset('storage/' . $_productDetails->product_image) }}"
                                                    alt="">
                                                <img class="hover-img"
                                                    src="{{ asset('storage/' . $_productDetails->second_image) }}"
                                                    alt="">
                                            </a>
                                        </div>
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <span>
                                            <a href="{{ route('singleproduct', ['url' => $_productDetails->url_key]) }}"
                                                class="product-title"><!-- {{ $_productDetails->name }} -->
                                        ...
                                        <div class="product-action-1 pt-3 show">
                                            ...
                                            <a aria-label="Add To Wishlist" class="action-btn hover-up"
                                                href="shop-wishlist.html"><i class="fa-regular fa-heart"></i></a>
                                            <a aria-label="Add To Cart" class="action-btn hover-up"
                                                href="{{ route('add.to.cart', $_productDetails->id) }}"><i
                    ...
                    <div class="col-lg-12 col-12">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-12 m-auto d-block  must_detail">
                                <a href="{{ $homeSection->rlc_section_image_1_link }}">
                                    <div class="border p-0 rounded hover-up pt-0 h-100">
                                    <div class="h-100">
                                        <img src="{{ asset('storage/' . $homeSection->rlc_section_image_1) }}"
                                            alt="" width="500px" height="600px">
                                    </div>
                                    <div class="text-center"
                                        style="background-color:black;border-radius:0 0 5px 5px;margin-top:-10px">
                            ...
                            <div class="col-lg-4 col-md-6 col-12 m-auto d-block  must_detail">
                                <a href="{{ $homeSection->rlc_section_video_link }}">
                                    <div class="border p-0 rounded hover-up pt-0 h-100">
                                    <div class="h-100">
                            ...
                            <div class="col-lg-4 col-md-6 col-12 m-auto d-block must_detail">
                                <a href=" {{ $homeSection->rlc_section_image_2_link }} ">
                                    <div class="border p-0 rounded hover-up pt-0 h-100">
                                        <div class="h-100">
                                            <img src="{{ asset('storage/' . $homeSection->rlc_section_image_2) }}"
                                                alt="" width="500px" height="600px">
                                        </div>
                                        <div class="text-center"
                                            style="background-color:black;border-radius:0 0 5px 5px;margin-top:-10px">
                        ...
                        <ul class="nav nav-tabs right no-border" id="myTab-1" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="nav-tab-three-1" data-bs-toggle="tab"
                                    ...
                                    aria-controls="tab-three" aria-selected="false">Necklaces
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="tab-content wow fadeIn animated" id="myTabContent-1">
                                            ...
                                            @foreach ($product1 as $_productDetails)
                                                <div class="product-cart-wrap my-3 hover-up">
                                                    <div class="product-img-action-wrap ">
                                                        <div class="product-img product-img-zoom">
                                                            <a
                                                                href="{{ route('singleproduct', ['url' => $_productDetails->url_key]) }}">
                            ...
                            <div class="tab-pane fade" id="tab-four-1" role="tabpanel" aria-labelledby="tab-four-1">
                                <div class="carausel-4-columns-cover arrow-center position-relative">
                                    <div class="slider-arrow slider-arrow-2 carausel-4-columns-arrow"
                                        id="carausel-4-columns-4-arrows"></div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-12 m-auto d-block py-2 must_detail">
                        <div class="border p-0 rounded hover-up pt-0" style="background-color:#f8e7e7;">
                            <div class="">
                                <img src="{{ asset('storage/' . $homeSection->bjp_section_image_1) }}"
                                    alt="{{ $homeSection->bjp_section_image_1_alt }}">
                            </div>
                            <div class="text-center">
                                ...
                                <div class="d-flex justify-content-start align-items-center view_detail w-100  mb-3">
                                    <a href="{{ $homeSection->bjp_section_image_1_link }}"
                                        class="d-block m-auto p-1 px-3"
                                        style="font-size: 14px;background-color: transparent;color: black;">Shop Now<i
                                            class="fa-solid fa-angle-right ps-2"></i></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 m-auto d-block py-2 must_detail">
                        <div class="border p-0 rounded hover-up pt-0" style="background-color: #e2eff5;">
                            <div class="">
                                <img src="{{ asset('storage/' . $homeSection->bjp_section_image_2) }}"
                                    alt="{{ $homeSection->bjp_section_image_2_alt }}">
                            </div>
                            <div class="text-center">
                                <h3 class="pt-3">{{ $homeSection->bjp_section_image_2_title }}</h3>
                                <h4 class="py-2">{{ $homeSection->bjp_section_image_2_name }}</h4>
                                <div class="d-flex justify-content-start align-items-center view_detail w-100  mb-3">
                                    <a href="{{ $homeSection->bjp_section_image_2_link }}"
                                        class="d-block m-auto p-1 px-3"
                                        style="font-size: 14px;background-color: transparent;color: black;">Shop Now<i
                                            class="fa-solid fa-angle-right ps-2"></i></a>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 m-auto d-block py-2 must_detail">
                        <div class="border p-0 rounded hover-up pt-0" style="background-color: #e0dbee;">
                            <div class="">
                                <img src="{{ asset('storage/' . $homeSection->bjp_section_image_3) }}"
                                    alt="{{ $homeSection->bjp_section_image_3_alt }}">
                            </div>
                            <div class="text-center">
                                <h3 class="pt-3">{{ $homeSection->bjp_section_image_3_title }}</h3>
                                <h4 class="py-2">{{ $homeSection->bjp_section_image_3_name }}</h4>
                                <div class="d-flex justify-content-start align-items-center view_detail w-100  mb-3">
                                    <a href="{{ $homeSection->bjp_section_image_3_link }}"
                                        class="d-block m-auto p-1 px-3"
                                        style="font-size: 14px;background-color: transparent;color: black;">Shop Now<i
                                            class="fa-solid fa-angle-right ps-2"></i></a>
                                </div>
                ...
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-6 px-1">
                                <img src="{{ asset('storage/' . $homeSection->bwu_section_image_1) }}"
                                    class=" p-0 m-0 homepage_donation_img hover-up"
                                    alt="{{ $homeSection->bwu_section_image_1_alt }}">
                            </div>
                            <div class="col-lg-6 col-6 px-1">
                                <img src="{{ asset('storage/' . $homeSection->bwu_section_image_2) }}"
                                    class=" p-0 m-0 homepage_donation_img hover-up"
                                    alt="{{ $homeSection->bwu_section_image_2_alt }}">
                            </div>
                            <div class="col-lg-6 col-6 px-1">
                                <img src="{{ asset('storage/' . $homeSection->bwu_section_image_3) }}"
                                    class=" p-0 m-0 homepage_donation_img hover-up"
                                    alt="{{ $homeSection->bwu_section_image_3_alt }}">
                            </div>
                            <div class="col-lg-6 col-6 px-1">
                                <img src="{{ asset('storage/' . $homeSection->bwu_section_image_4) }}"
                                    class=" p-0 m-0 homepage_donation_img hover-up"
                                    alt="{{ $homeSection->bwu_section_image_4_alt }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 py-3 d-flex flex-column align-content-center justify-content-center ps-lg-4">
                        ...
                        <div class=" d-flex justify-content-sm-start align-items-center view_detail hover-up">
                            <a href="{{ $homeSection->bwu_section_btn_link }}"
                                class="fs-6">{{ $homeSection->bwu_section_btn_name }}<i
                                    class="fa-solid fa-angle-right ps-2"></i></a>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="blog-card m-1 my-3">
                                    <div class="card-banner">
                                        ...
                                        <img class="banner-img"
                                            src="{{ asset('storage/lastblog_image/' . $_items->lastblog_image) }}"
                                            alt='{{ $_items->alt }}'>
                                    </div>
                                    <div class="card-body">
                    ...
                    @if ($gellary)
                        @foreach ($gellary as $gallary)
                            <div class="col-lg-3 col-md-4 col-sm-6 col-6 p-1 m-auto d-block image_show_hover hover-up">
                                <img src="{{ asset('storage/' . $gallary->image) }}" style="width: 100%;height: 100%;"
                                    alt="{{ $gallary->alt }}">
                            </div>
                        @endforeach
                    @endif
